...
\tbd[Cross-reference flag: no principle is currently titled ``Vision First.''
The trade-space language here overlaps III.1 (Engineers as Self-Managing) and the
vision language overlaps III.2 (Vision Sourcing). See open structural question 5
--- resolve with Eric before final draft.]
...
\tbd[Principle body to be developed from Eric's direct narration.
This section is a placeholder---do not develop without his input.]
