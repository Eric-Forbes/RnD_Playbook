...
\principle{Demo what you have, on cadence. Positive discipline, not punishment.}
...
% ----------------------------------------------------------
\section{Humble / Parenting-Style Leadership}
...
\begin{storybox}
\textbf{Story (banked --- Section II confirmed, parent principle TBD):}
A leader who hoarded information created invisible hierarchy and eroded trust.
\tbd[Raw capture only. Full story to be developed from Eric's narration
before attaching.]
\end{storybox}
