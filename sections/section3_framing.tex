...
the team understands---is one of the most valuable assets in an R\&D program.
...
\principle{\textit{\color{midgray}[TBD: Thesis unconfirmed. May merge with Radical Optimism---resolve with Eric.]}}

\tbd[Draft framing only---not yet confirmed by Eric: there may be a quality of
early-stage frontier work that is fragile and generative, which organizational
processes can inadvertently kill, and which the leader must shield from premature
institutionalization. Whether this stands alone or merges into Radical Optimism
is an open structural question. Do not develop further without Eric's direction.]
